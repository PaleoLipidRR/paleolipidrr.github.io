...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/paleolipidrr.bsky.social", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ronnakritr", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-1425-8737", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=AGcBWlAAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/paleolipidrr", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://paleolipidrr.github.io/assets/pdf/CV_Rattanasriampaipong.pdf", "_blank");
        },
      },{
      id: 'light-theme',
